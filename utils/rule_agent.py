...
class RuleAgent:
    ...
    """
    randomly modify l system json config
    """
    ...
    def generate_prompt(
        ...
        Args:
            ...
            allowed_symbols: symbols llm can modify
    ...
    1. Rules must follow this structure:
       - "pattern": The symbol to match (e.g., "A", "F", "F(x,y)")
    ...
    2. All valid commands our L-system supports:
    ...
    4. Adjust params reasonably according to the requested entity:
       - length: 5-50 (affects length of drawing piece)
       - width: 0.5-5 (affects thickness of drawing piece)
    ...
    Do not include any explanation or markdown formatting - only the raw JSON object."""
        ...
        prompt += (
            f"\nOperate only with  ALLOWED SYMBOLS: {sorted(list(allowed_symbols))}\n"
        )
